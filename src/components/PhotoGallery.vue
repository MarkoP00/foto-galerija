...
const emit = defineEmits(["imageLink", "sortBy", "onReset", "deleteImageId"]);
...
async function deleteImage(id) {
  try {
    const response = await fetch(
      `https://aleksandar-photo-default-rtdb.europe-west1.firebasedatabase.app/images/${clickedImageId.value}.json`,
      {
        method: "DELETE",
        headers: {
